...
<div class="bg-light border-right" id="sidebar-wrapper" style="background-color: green;position: relative;">
      ...
      <div class="list-group list-group-flush sidebar-active" >
        ...
        <a href="#three" class="list-group-item list-group-item-action bg-light active">REQUESTS</a>
